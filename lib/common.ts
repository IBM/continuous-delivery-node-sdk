 ...
 * continuous-delivery-node-sdk/0.0.1 (lang=node.js; os.name=Linux; os.version=19.3.0; node.version=v10.15.3)
 *
 * In the example above, the analytics tool will parse the user-agent header and
 * use the following properties:
 * "continuous-delivery-node-sdk" - the name of your sdk
...
export function getSdkHeaders(
  ...
  const sdkName = 'continuous-delivery-node-sdk';
